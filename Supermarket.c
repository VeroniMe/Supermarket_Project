...
int		initSuperMarket(SuperMarket* pMarket, char* ifCompress, const char* superMarketFile, const char* customersFileName)
{
	...
	{
		if (loadSuperMarketFromFile(pMarket, superMarketFile, customersFileName) == 1)
		{
	...
	else if (!strcmp(ifCompress, "1"))
	{
		...
		if (readSuperMarketFromCompressFile(pMarket, superMarketFile, customersFileName))
		{
			printf("Supermarket successfully loaded from files\n");
			return 1;
		}
